...
# EpiNow2
plot_epinow <- this_plot(pd=EpiNow2_summrt,
                         title="EpiNow2",
                         rt_sim=all_data$rt)
...
```{r score-output}
mae.epinow <- get_mae(pd = EpiNow2_summrt,                                                   rt_sim=all_data$rt)
mae.epiestim <- get_mae(pd = EpiEstim_summrt,                                                   rt_sim=all_data$rt)
mae.rtestim <- get_mae(pd = Rtestim_summrt,                                                   rt_sim=all_data$rt)
mae.epilps <- get_mae(pd = EpiLPS_summrt,                                                   rt_sim=all_data$rt)
