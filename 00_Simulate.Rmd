...
renderPlot({
    ...
    second_axis_ticks <- data.frame(
      xmin = c(sx-0.1, sx-.1, sx-.1, sx-.1, sx-.1),
    ...
    geom_segment(data = second_axis_ticks, aes(x = xmin, xend = xmax, 
                                               y = ymin, yend = ymax), 
                 linewidth = 0.2) +
    geom_text(data = second_axis_ticks, aes(x = xmin - 0.5,  
